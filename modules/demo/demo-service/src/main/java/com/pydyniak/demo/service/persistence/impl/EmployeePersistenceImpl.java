...
package com.pydyniak.demo.service.persistence.impl;
...
import com.pydyniak.demo.exception.NoSuchEmployeeException;
import com.pydyniak.demo.model.Employee;
import com.pydyniak.demo.model.impl.EmployeeImpl;
import com.pydyniak.demo.model.impl.EmployeeModelImpl;
import com.pydyniak.demo.service.persistence.EmployeePersistence;
import com.pydyniak.demo.service.persistence.impl.constants.DemoPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, EmployeeImpl.class, primaryKey);
		}
	}
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.pydyniak.demo.model.Employee"),
			true);
	}
	...
	static {
		try {
			Class.forName(DemoPersistenceConstants.class.getName());
		}
